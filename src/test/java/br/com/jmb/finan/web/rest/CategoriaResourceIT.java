...
import br.com.jmb.finan.repository.CategoriaRepository;
...
class CategoriaResourceIT {
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria().dsCategoria(DEFAULT_DS_CATEGORIA);
        return categoria;
    }
    ...
    public static Categoria createUpdatedEntity(EntityManager em) {
        Categoria categoria = new Categoria().dsCategoria(UPDATED_DS_CATEGORIA);
        return categoria;
    }
    ...
    void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getDsCategoria()).isEqualTo(DEFAULT_DS_CATEGORIA);
    }
    ...
    void getAllCategorias() throws Exception {
        ...
        restCategoriaMockMvc
            ...
            .andExpect(jsonPath("$.[*].dsCategoria").value(hasItem(DEFAULT_DS_CATEGORIA)));
    }
    ...
    void getCategoria() throws Exception {
        ...
        restCategoriaMockMvc
            ...
            .andExpect(jsonPath("$.dsCategoria").value(DEFAULT_DS_CATEGORIA));
    }
    ...
    void putNewCategoria() throws Exception {
        ...
        updatedCategoria.dsCategoria(UPDATED_DS_CATEGORIA);
        ...
        Categoria testCategoria = categoriaList.get(categoriaList.size() - 1);
        assertThat(testCategoria.getDsCategoria()).isEqualTo(UPDATED_DS_CATEGORIA);
    }
    ...
    void partialUpdateCategoriaWithPatch() throws Exception {
        ...
        partialUpdatedCategoria.dsCategoria(UPDATED_DS_CATEGORIA);

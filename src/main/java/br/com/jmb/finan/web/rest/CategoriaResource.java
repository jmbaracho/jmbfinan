...
/**
 * REST controller for managing {@link br.com.jmb.finan.domain.Categoria}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Categoria> partialUpdateCategoria(
        ...
        Optional<Categoria> result = categoriaRepository
            ...
            .map(existingCategoria -> {
                if (categoria.getDsCategoria() != null) {
                    existingCategoria.setDsCategoria(categoria.getDsCategoria());
                }
